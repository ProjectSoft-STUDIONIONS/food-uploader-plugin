...
function food_plugin_add_admin_style_script() {
	global $plugin_name;
	wp_register_style( 'food-uploader-plugin', plugins_url( $plugin_name . '/css/main.css' ), array(), '1.0.0-dev-1739209641', false );
	...
	if(is_file(FOOD_ABSPATH . '/viewer/fancybox.min.js')):
		wp_register_script( 'food-uploader-plugin_fancybox_js', site_url('viewer/fancybox.min.js'), array(), '1.0.0-dev-1739209641', true );
		wp_register_style( 'food-uploader-plugin_fancybox_css', site_url('viewer/app.min.css'), array(), '1.0.0-dev-1739209641', false );
		wp_enqueue_style( 'food-uploader-plugin_fancybox_css' );
		wp_enqueue_script( 'food-uploader-plugin_fancybox_js');
	endif;

	wp_register_script( 'food-uploader-plugin_main', plugins_url( $plugin_name . '/js/main.min.js' ), array(), '1.0.0-dev-1739209641', true );
