...
?>
	<form action="<?= $url;?>" method="post">
		...
		<table class="form-table" style="width: 100%;">
			<tr valign="top">
				<th scope="row"><?= __("Дополнительные директории", $this::FOOD_NAME);?></th>
				<td>
					<input type="text" name="food_folders" value="<?= esc_attr( get_option('food_folders', '') );?>" style="width: 100%;">
					<p class="description"><em><?= __("Вводить через пробел, запятую или точку с запятой<br>Директория <code>food</code> присутствует всегда и независимо от этой настройки", $this::FOOD_NAME);?></em></p>
				</td>
			</tr>
			<tr valign="top">
				<th scope="row"><?= __("Автоудаление старых файлов", $this::FOOD_NAME);?></th>
				<td>
			...
			<tr valign="top">
				<th scope="row"><?= __("Автоудаление старых файлов старше", $this::FOOD_NAME);?></th>
				<td>
